...
@Component({
  selector: 'app-caracteristiques-tel',
  templateUrl: './caracteristiques-tel.component.html',
  styleUrls: ['./caracteristiques-tel.component.css']
})
export class CaracteristiquesTelComponent implements OnInit {
  ...
  checkCaract(array: any) {
    for (var val of array) {
      if (val.capacite == this.prod.capacite && val.dimension == this.prod.dimension && val.camera == this.prod.camera && val.ecran == this.prod.ecran) {
