...
@Component({
  selector: 'app-caracteristique-objetconnecte',
  templateUrl: './caracteristique-objetconnecte.component.html',
  styleUrls: ['./caracteristique-objetconnecte.component.css']
})
export class CaracteristiqueObjetconnecteComponent implements OnInit {
  ...
  checkCaract(array: any) {
    for (var val of array) {
      if (val.connectivite == this.prod.connectivite && val.alimentation == this.prod.alimentation && val.appareilscompatibles == this.prod.appareilscompatibles) {
