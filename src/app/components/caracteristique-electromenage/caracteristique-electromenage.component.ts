...
@Component({
  selector: 'app-caracteristique-electromenage',
  templateUrl: './caracteristique-electromenage.component.html',
  styleUrls: ['./caracteristique-electromenage.component.css']
})
export class CaracteristiqueElectromenageComponent implements OnInit {
  ...
  checkCaract(array: any) {
    for (var val of array) {
      if (val.dimensionecran == this.prod.dimensionecran && val.technologieaffichage == this.prod.technologieaffichage && val.resolution == this.prod.resolution && val.capacitel == this.prod.capacitel && val.capacitek == this.prod.capacitek && val.vitesse == this.prod.vitesse && val.puissance == this.prod.puissance) {
