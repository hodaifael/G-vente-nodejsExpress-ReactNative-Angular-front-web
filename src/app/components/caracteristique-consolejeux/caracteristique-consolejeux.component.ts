...
@Component({
  selector: 'app-caracteristique-consolejeux',
  templateUrl: './caracteristique-consolejeux.component.html',
  styleUrls: ['./caracteristique-consolejeux.component.css']
})
export class CaracteristiqueConsolejeuxComponent implements OnInit {
  ...
  checkCaract(array: any) {
    for (var val of array) {
      if (val.stokage == this.prod.stokage && val.ram == this.prod.ram && val.alimentation == this.prod.alimentation && val.communicationwifi == this.prod.communicationwifi) {
